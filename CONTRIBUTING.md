...
`setup` conserva tu clave existente. Si hay nuevas variables en `.env.example`, agrégalas manualmente a tu `.env`. Git no sincroniza claves, perfiles ni recetas guardadas en el navegador.
...
- Nunca incluir `.env`, claves, contraseñas ni datos médicos o personales reales en commits, capturas o incidencias.
